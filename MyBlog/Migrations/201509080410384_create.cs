namespace MyBlog.Migrations
{
    ...
    public partial class create : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PostId = c.Int(nullable: false),
                        LikePlus = c.Int(nullable: false),
                        LikeMinus = c.Int(nullable: false),
                        RowVersion = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PostContent", "PostId", "dbo.Post");
            DropForeignKey("dbo.Post", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.PostComment", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.Post", new[] { "ApplicationUserId" });
            DropIndex("dbo.PostContent", new[] { "PostId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.PostComment", new[] { "ApplicationUserId" });
            DropTable("dbo.Tag");
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.PostView");
