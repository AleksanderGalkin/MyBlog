...
{
    [TestClass()]
    public class PluginImagePostTypeBandControllerTests
    {
        [Export] //It needs for MEF metadata loading.
        public IDataStoreBand _ds;
        PluginImagePostTypeBandController controller;
        ...
        public void PluginImagePostTypeBand_ds_is_null()
        {
            _ds = null;
            controller = new PluginImagePostTypeBandController(_ds);
        }
